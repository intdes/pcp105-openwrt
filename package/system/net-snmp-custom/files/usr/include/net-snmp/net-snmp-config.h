...
#define NETSNMP_CONFIGURE_OPTIONS " '--host=arm-linux' '--prefix=/usr' '--disable-embedded-perl' '--disable-manuals' '--disable-scripts' '--with-mib-modules=ucd-snmp/lmsensorsMib hyraxpcp105' '--with-install-prefix=/home/will/Hyrax/hyr03/utils/net-snmp-5.7.3/install' 'host_alias=arm-linux' 'CC=i486-openwrt-linux-gcc' 'CFLAGS=-I/opt/OpenWrt/staging_dir/target-i386_i486_musl-1.1.14/usr/include' 'LDFLAGS=-L/opt/OpenWrt/staging_dir/target-i386_i486_musl-1.1.14/usr/lib' 'CPP=i486-openwrt-linux-cpp'"
